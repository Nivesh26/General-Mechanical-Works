        ...
        <div className="max-w-lg mx-auto rounded-2xl border border-gray-200 bg-white p-8 shadow-sm text-center">
          {isSuccess ? (
            <>
              ...
              <p className="mt-3 text-gray-600">
                {orderNumber
                  ? `Your order ${orderNumber} has been placed and paid via eSewa.`
          ...
          {isError ? (
            <>
              ...
              <p className="mt-3 text-gray-600">
                {message ?? 'We could not verify your eSewa payment. Please contact support if amount was deducted.'}
              </p>
            </>
          ) : null}
...
export default EsewaPaymentResult
